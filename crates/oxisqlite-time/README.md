...
Date/time SQL function extension for the C-free **oxisqlite** engine — a
Pure-Rust fork of [limbo](https://github.com/tursodatabase/limbo) 0.0.22,
internal to the OxiSQL workspace.

This crate provides the engine's date/time SQL functions, registered through the
oxisqlite extension API.

- **Role:** date/time SQL function extension.
- **Approx LOC:** ~1,231.
